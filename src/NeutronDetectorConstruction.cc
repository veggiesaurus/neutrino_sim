...
NeutronDetectorConstruction::NeutronDetectorConstruction(G4double s_boronLoading, G4double s_boronEnrichment, G4double s_hexRadius, G4double s_hexLength, G4int s_edgeCells)
...
void NeutronDetectorConstruction::ConstructHexDetector(G4Material* material)
{
	//Hexagon
...
void NeutronDetectorConstruction::ConstructSquareDetector(G4Material* material)
{
	//Square
...
void NeutronDetectorConstruction::SetMaxStep(G4double maxStep)
{
