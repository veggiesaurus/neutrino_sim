...
// $Id$
//
/// \file NeutronSimTrackingAction.cc
...
NeutronSimTrackingAction::NeutronSimTrackingAction(ofstream* s_verboseOut, G4double s_verticalResolution, bool s_outputRealistic)
...
NeutronSimTrackingAction::~NeutronSimTrackingAction()
{
...
void NeutronSimTrackingAction::GetStatistics(G4int& numTracks, G4double& alphaMeanX, G4double& alphaSigmaX, G4double& alphaMeanY, G4double& alphaSigmaY, G4double& alphaMeanZ, G4double& alphaSigmaZ, G4double& recMeanTheta, G4double& recSigmaTheta, G4double& alphaMeanT, G4double& alphaSigmaT)
{
	if (numAlphaTracks)
	{
